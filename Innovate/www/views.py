...
def show_wedding_videos(request):
	list_of_videos = video.objects.filter(video_genre='w') | video.objects.filter(video_genre='W')
...
def show_documentaries_videos(request):
	list_of_videos = video.objects.filter(video_genre='d') | video.objects.filter(video_genre='D')
...
def show_promo_videos(request):
	list_of_videos = video.objects.filter(video_genre='p') | video.objects.filter(video_genre='P')
